...
class ZafrasController extends AppController
{
    public function index(){
        if($this->checkUser()){
            ...
            Session::set('anio',(isset($_POST['txtanio'])) ? $this->clean($_POST['txtanio']) : Session::get('anio'));
            ...
            Session::set('ped1', Session::get("anio") ."-". Session::get("ped1"));
            Session::set('ped2', Session::get("anio") ."-". Session::get("ped2"));
