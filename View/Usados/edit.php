...
<form class="form-horizontal style-form" method="post" action="index.php?c=usados&a=edit&p=<?php echo \App\Session::get('id'); ?>&v=<?php echo \App\Session::get('v'); ?>" name="frmedit">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtcap" class="form-control" required="required" value="<?php echo $usado->getCapacidad(); ?>" tabindex="2" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div style="text-align: center;">
            ...
            <a href="index.php?c=usados&a=index&p=<?php echo App\Session::get('id'); ?>"><button type="button" name="btncancelar" value="Cancelar" class="btn btn-theme04" tabindex="4"><i class="fa fa-times"></i>&nbsp;Cancelar</button></a>
        </div>
    </div>
</form>