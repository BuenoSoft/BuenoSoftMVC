        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtnombre" class="form-control" required="required" autofocus="autofocus" placeholder="Ej: Ruta 3" onkeypress="return validarTextoyNum(event);" pattern="[A-Za-z\s\d\/]*" maxlength="20" tabindex="1"  />
                    </div>
                </div>
                <div class="form-group">
