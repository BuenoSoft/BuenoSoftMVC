        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtcoord" onkeypress="return validarNumeroPC(event)" class="form-control" pattern="[+-]?[\d]{1,3}.{1}?[\d]{1,3},[+-]?[\d]{1,3}.{1}?[\d]{1,3}" required="required" placeholder="Ej: -30.434,-57.439" tabindex="2" />
                    </div>
                </div>
            </div>
