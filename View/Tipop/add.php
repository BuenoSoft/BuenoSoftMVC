...
<form class="form-horizontal style-form" method="post" action="index.php?c=tipop&a=add" name="frmadd" autocomplete="off">
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtnombre" class="form-control" required="required" autofocus="autofocus"  placeholder="Ej: Siembra" onkeypress="return validarTexto(event);" pattern="[A-Za-z\s]*" maxlength="10" tabindex="1"  />
                    </div>
                </div>
            </div>
