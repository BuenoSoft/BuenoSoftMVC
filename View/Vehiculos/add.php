        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtmat" class="form-control" autofocus required placeholder="Ej: T458-BDD" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Padrón del Vehículo</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtpadron" class="form-control" required placeholder="Ej: 1109971" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtmotor" class="form-control" required placeholder="Ej: kawata78" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Chasis del Vehículo</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtchasis" class="form-control" autofocus required placeholder="Ej: 285514564" />
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtcap" class="form-control" required placeholder="Ej: 25,8" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Modelo del Vehículo</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtmodelo" class="form-control" required placeholder="Ej: Gol G5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Marca del Vehículo</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtmarca" class="form-control" required placeholder="Ej: Wolkswagen" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Año del Vehículo</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtanio" class="form-control" required placeholder="Ej: 2010" onkeypress="return validarNumero(event);" />
                    </div>
                </div>
                <div class="form-group">
