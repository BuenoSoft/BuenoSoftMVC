        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input list="tipov" class="form-control" placeholder="Seleccione Tipo" required="required" name="cboxtipo" tabindex="3" />
                        <datalist id="tipov">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input list="unim" class="form-control" placeholder="Seleccione Unidad" required="required" name="cboxuni" tabindex="6" />
                        <datalist id="unim">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input list="combustibles" class="form-control_datalist" placeholder="Seleccione Combustible" required="required" name="cboxcomb" tabindex="11"/>
                        ...
                        <input type="button" onclick="frmadd.submit();" value="Buscar" class="btn btn-theme01" tabindex="12" />
                    </div>
                </div>
            </div>
        </div>
