        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input list="combustibles" class="form-control_datalist" placeholder="Seleccione Combustible" required="required" name="cboxcomb" value="<?php echo $vehiculo->getCombustible()->getId(); ?>" />
