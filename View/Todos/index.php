    ...
    <a id="a_795f61a61e38fcaef451a251c5076bcc" href="http://www.tiempo.com/tomas-gomensoro.htm" target="_blank"
        ...
        <section class="features text-center section-padding" id="features">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1 class="arrow">Propuesta para su negocio rural</h1>
                <div class="features-wrapper">
                  <div class="col-md-4 wp2">
                    <div class="icon">
                      <i class="fa fa-check-square"></i>
                    </div>
                    <h2>Aplicación precisa</h2>
              ...
              <div class="row">
                <div class="col-md-5 col-md-offset-7">
                  <div id="servicesSlider">
                    <ul class="slides">
                      <li>
                        <h1 class="arrow">Trabajo realizados</h1>
                      ...
                      <li>
                        <h1 class="arrow">Palabra de nuestros clientes</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ultricies nulla non metus pulvinar imperdiet. Praesent non adipiscing libero. </p>
                        <p>
                        Mauris ultrices odio vitae nulla ultrices iaculis. Nulla rhoncus odio eu lectus faucibus facilisis. Maecenas ornare augue vitae sollicitudin accumsan. </p>
                        <p>Etiam eget libero et erat eleifend consectetur a nec lectus. Sed id tellus lorem. Suspendisse sed venenatis odio, quis lobortis eros.</p>
                ...
                <ul class="slides">
                  <li>
                    <div class="col-md-4 wp4">
                      <div class="overlay-effect effects clearfix">
                        <div class="img">
                          <img src="Public/img/principal/portfolio-01.jpg" alt="Portfolio Item">
                          <div class="overlay">
                      ...
                      <h2>Trabajo finalizados</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ultricies nulla non metus pulvinar imperdiet. Praesent non adipiscing libero.</p>
                    </div>
                    <div class="col-md-4 wp4 delay-05s">
                      <div class="overlay-effect effects clearfix">
                        <div class="img">
                          <img src="Public/img/principal/portfolio-02.jpg" alt="Portfolio Item">
                          <div class="overlay">
                            <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                            <a class="close-overlay hidden">x</a>
                          </div>
                    ...
                    <div class="col-md-4 wp4 delay-1s">
                      <div class="overlay-effect effects clearfix">
                        <div class="img">
                          <img src="Public/img/principal/portfolio-03.jpg" alt="Portfolio Item">
                          <div class="overlay">
                            <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                            <a class="close-overlay hidden">x</a>
                          </div>
                  ...
                  <li>
                    <div class="col-md-4 wp4">
                      ...
                      <h2>Algo breve</h2>
                      <p>La espera a un trabajo realizar puede llevar mas tiempo de lo pensado y forzar el doble de gastos.</p>
                    </div>
                    <div class="col-md-4 wp4 delay-05s">
                      <div class="overlay-effect effects clearfix">
                        <div class="img">
                      ...
                      <h2>Algo más breve</h2>
                      <p>El tiempo es ahora!.</p>
                    </div>
                    <div class="col-md-4 wp4 delay-1s">
                      <div class="overlay-effect effects clearfix">
                        <div class="img">
        ...
        <section class="team text-center section-padding" id="team">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1 class="arrow">Nuestro Equipo de trabajo</h1>
              </div>
            </div>
            <div class="row">
                  ...
                  <ul class="slides">
                    <li>
                      <div class="col-md-4 wp5">
                        <img src="Public/img/principal/pablobueno.png" alt="Team Member">
                        <h2>Pablo Bueno</h2>
                        <p>Piloto de avión. Profesional. Aplicación aerea todo terreno.</p>
                        <div class="social">
                          <ul class="social-buttons">
                            <li><a href="https://www.facebook.com/pablo.bueno.58?fref=ts" class="social-btn"><i class="fa fa-facebook"></i></a></li>
                      ...
                      <div class="col-md-4 wp5 delay-05s">
                        <img src="Public/img/principal/oscarbueno.png" alt="Team Member">
                        <h2>Oscar Bueno</h2>
                        <p>Piloto de avión. Profesional. Directro de Empresa Bueno Servicios.</p>
                        <div class="social">
                          <ul class="social-buttons">
                      ...
                      <div class="col-md-4 wp5 delay-1s">
                        <img src="Public/img/principal/secretaria.png" alt="Team Member">
                        <h2>Señorita Leins</h2>
                        <p>Secretaria. Encargada de administración y contacto con los clientes.</p>
                        <div class="social">
                          <ul class="social-buttons">
                            <li><a href="#" class="social-btn"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" class="social-btn"><i class="fa fa-twitter"></i></a></li>
        ...
        <section class="dark-bg text-center section-padding contact-wrap" id="contact">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1 class="arrow">Contactenos en línea</h1>
              </div>
            </div>
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="light-box box-hover">
                  ...
                  <p><a href="#">contacto@buenoservicios.com.uy</a></p>
                </div>
              </div>
            </div>
            <div class="row">
