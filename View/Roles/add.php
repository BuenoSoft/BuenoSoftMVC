...
<form class="form-horizontal style-form" method="post" action="index.php?c=roles&a=add" name="frmadd" autocomplete="off">
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtnombre" class="form-control" required="required" autofocus="autofocus"  placeholder="Ej: Encargado" onkeypress="return validarTexto(event);" pattern="[A-Za-z\s]*" tabindex="1"  />
                    </div>
                </div>
            </div>
