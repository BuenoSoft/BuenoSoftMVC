                            ...
                            foreach ($funcionarios as $funcionario){
                                if($funcionario->getEstado() == "H") {
                                    if($funcionario->checkTra(\App\Session::get('app'))){ ?>
                                        <input type="checkbox" name="funcionarios[]" value="<?php echo $funcionario->getId(); ?>" checked="checked" />&nbsp;<?php echo $funcionario->getDatoUsu()->getNombre()." Tipo: ".$funcionario->getRol()->getNombre(); ?><br />
                        <?php
