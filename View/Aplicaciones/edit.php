        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <datalist id="aeronaves">
                            <?php 
                                foreach ($aeronaves as $aeronave) { 
                                    if($aeronave->getEstado() == "H" and ($aeronave->getTipo()->getNombre() == "Avion" or $aeronave->getTipo()->getNombre() == "Aeronave")){
            ...
            <div class="showback">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtviento" onkeypress="return validarNumeroPC(event)" class="form-control" required="required" placeholder="" tabindex="7" value="<?php echo \App\Session::get("pass")[8]; ?>"/>
                    </div>
                </div>
            </div>
            <div class="showback">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="showback">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtfaja" onkeypress="return validarNumeroPC(event)" class="form-control" required="required" placeholder="" tabindex="11" value="<?php echo \App\Session::get("pass")[4]; ?>"/>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="showback">    
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txttaquiIni" onkeypress="return validarNumeroPC(event)" class="form-control" placeholder="" tabindex="15" value="<?php echo \App\Session::get("pass")[10]; ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Taquímetro Final</label>                        
                    <div class="col-sm-10">
                        <input type="text" name="txttaquiFin" onkeypress="return validarNumeroPC(event)" class="form-control" placeholder="" tabindex="16" value="<?php echo \App\Session::get("pass")[11]; ?>"/>
                    </div>
                </div> 
            </div>            
