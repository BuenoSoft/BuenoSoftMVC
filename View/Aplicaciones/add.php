        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="showback">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input list="terrestres" class="form-control" placeholder="Seleccione Terrestre"  name="terrestre" required="required" tabindex="12" value="<?php echo \App\Session::get("pass")[20]; ?>" />
