        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtnombre" class="form-control" maxlength="30" required="required" placeholder="Ej: Avión" autofocus="autofocus" onkeypress="return validarTexto(event);" pattern="[A-Za-z\s]*" tabindex="1"  />
                    </div>
                </div>
                <div class="form-group">
