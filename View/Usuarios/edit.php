            ...
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="text-align: center;">
                        <input type="hidden" name="hid" value="<?php echo $usuario->getDatoUsu()->getId(); ?>" /><?php echo $usuario->getDatoUsu()->getId(); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Documento del Sujeto</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtdoc" class="form-control" required="required" placeholder="Ej: 285514564" onkeypress="return validarNumero(event)" maxlength="12" value="<?php echo $usuario->getDatoUsu()->getDocumento(); ?>" tabindex="1"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Nombre del Sujeto</label>
                    <div class="col-sm-10">
                        <input type="text" name="txtnomsuj" class="form-control" required="required" placeholder="Ej: Luis Ottonello" onkeypress="return validarTexto(event)" value="<?php echo $usuario->getDatoUsu()->getNombre(); ?>" tabindex="2">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input id="suj" list="sujetos" class="form-control" required="required" placeholder="Seleccione un Tipo de Sujeto" name="cboxtiposuj" value="<?php echo $usuario->getDatoUsu()->getTipo(); ?>" tabindex="6" />
                        <datalist id="sujetos">
