...
<form class="form-horizontal style-form" method="post" action="index.php?c=usuarios&a=av_edit&d=<?php echo \App\Session::get('usu'); ?>" name="frmedit" autocomplete="off">
    <div class="row mt">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtuser" class="form-control" required="required" placeholder="Ej: pop32" maxlength="20" value="<?php echo $usuario->getNombre(); ?>" tabindex="7" />
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div style="text-align: center;">
                ...
                <a href="index.php?c=usuarios&a=view&d=<?php echo $usuario->getId(); ?>"><button type="button" name="btncancelar" value="Cancelar" class="btn btn-theme04" tabindex="12"><i class="fa fa-times"></i>&nbsp;Cancelar</button></a>
            </div>
        </div>
    </div>
</form>
