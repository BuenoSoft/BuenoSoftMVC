        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input name="tipo" list="tipov" id="tipo" class="form-control" placeholder="Seleccione Tipo de Vehículo" required="required" value="<?php echo $combustible->getTipo()->getId(); ?>" tabindex="3" />
                        <datalist id="tipov">
